	...
	<div class="col-md-12">
		<div class="portlet light ">
			<div class="portlet-title">
				<div class="caption">
					<label for="" style="color:#000;"><i class="fa fa-edit"></i> Area Details</label>
				</div>
					<div class="actions">
				...
				<a href="{{ URL::to('memberExcel/csv') }}"><button class="btn btn-success">Download CSV</button></a>	 -->		
					<input type="text" class="form-control input-medium pull-right" placeholder="Search Zone / Area..." id="search3">
				</div>
			</div>
  ...
  <table class="table table-condensed table-hover table-bordered" id="main_tble">
	...
	<?php $i = 0; ?>
	  ...
	  <tr>
        ...
        <td>{{$post['name']}}</td>
         <td><a href="{{action('AreaController@edit', $post['id'])}}" class="btn btn-warning input-sm">Edit</a></td>
        <td><form action="{{action('AreaController@destroy', $post['id'])}}" method="post">
            {{csrf_field()}}
