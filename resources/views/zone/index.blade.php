	...
	<div class="col-md-12">
		<div class="portlet light ">
			<div class="portlet-title">
				<div class="caption">
					<label for="" style="color:#000;"><i class="fa fa-edit"></i> Zone Details</label>
				</div>
					<div class="actions">
				...
				<a href="{{ URL::to('memberExcel/csv') }}"><button class="btn btn-success">Download CSV</button></a>	 -->		
					<input type="text" class="form-control input-medium pull-right" placeholder="Search Zone..." id="search3">
				</div>
			</div>
	...
	<?php $i = 0; ?>
	  ...
	  <tr>
        ...
        <td width="75%">{{$post['name']}}</td>
         <td><a href="{{action('ZoneController@edit', $post['id'])}}" class="btn btn-warning input-sm">Edit</a></td>
        <td><form action="{{action('ZoneController@destroy', $post['id'])}}" method="post">
            {{csrf_field()}}
